...
public class Aims {
    ...
    public static void main(String[] args) {
        CompactDisc cd = new CompactDisc(1,"The Lion King","Animation", 10.5f);
        DigitalVideoDisc dvd = new DigitalVideoDisc(2,"The Hobbit", "The Hobbit", 25f );
        Book book = new Book(3,"Harry Potter", "Fantasy", 30.65f);
        store.addMedia(cd); 
        store.addMedia(dvd); 
        store.addMedia(book);
